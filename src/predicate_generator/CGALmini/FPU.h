...
#  error "I do not know how to define CGAL_IA_MIN_FLOAT and CGAL_IA_MAX_FLOAT..."
#else
#  include <limits>
#  define CGAL_IA_MIN_DOUBLE std::numeric_limits<double>::denorm_min()
#  define CGAL_IA_MAX_DOUBLE (std::numeric_limits<double>::max)()
#  define CGAL_IA_MIN_FLOAT std::numeric_limits<float>::denorm_min()
#  define CGAL_IA_MAX_FLOAT (std::numeric_limits<float>::max)()
#endif
...
#  error "I do not know how to write CGAL_IA_FORCE_TO_FLOAT()..."
#else
#  define CGAL_IA_FORCE_TO_DOUBLE(x) (x)
#  define CGAL_IA_FORCE_TO_FLOAT(x) (x)
#endif
