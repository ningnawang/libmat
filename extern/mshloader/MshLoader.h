...
class MshLoader {
 ...
 public:
  ...
  size_t get_nodes_per_element() const { return m_nodes_per_element; }

  size_t get_element_type() const { return m_element_type; }

 public:
  enum ErrorCode { INVALID_FORMAT, NOT_IMPLEMENTED };
